        ...
        <div className="w-full max-w-md">
          ...
          >
            <div className="mb-4">
              ...
              <input
                className="focus:lime-600 w-full appearance-none rounded border border-lime-700 bg-slate-50 px-3 py-2 placeholder-gray-600 focus:outline-none focus:ring-2 focus:ring-lime-700 dark:bg-gray-800 dark:placeholder-gray-400"
                id="password"
                type="password"
                value={password}
